...
LOGFORMAT = "/tmp/logs/ulog%s.log"
EVTFORMAT = "/tmp/logs/uevt%s.log"
PENLOGFORMAT = "/tmp/logs/pending/ulog%s.log"
LOGDIR = "/tmp/logs/"
REPTDIR = "/tmp/reports/"
PENDIR = "/tmp/logs/pending" # where to put completed day's log
